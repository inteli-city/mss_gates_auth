...
class Test_RefreshTokenUsecase:
    def test_refresh_token_usecase(self):
        ...
        tokens = usecase('valid_refresh_token-teste@gmail.com')

        expected_refresh_token = "valid_access_token-teste@gmail.com"
        valid_refresh_token = "valid_refresh_token-teste@gmail.com"
        expected_id_token = "valid_id_token-teste@gmail.com"
    ...
    def test_refresh_token_usecase_invalid_refresh_token(self):
        ...
        with pytest.raises(ForbiddenAction):
            tokens = usecase('invalid_refresh_token-teste@gmail.com')
    ...
    def test_refresh_token_usecase_invalid_email(self):
        ...
        with pytest.raises(ForbiddenAction):
            tokens = usecase('valid_refresh_token-teste@gmail')